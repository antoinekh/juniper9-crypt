...
> **Prefer a browser?** Encode and decode `$9$` (and `$8$`, and Nokia SR OS custom-hash) at **[network-secret.pages.dev](https://network-secret.pages.dev/)**. It runs the same algorithm fully client-side - nothing you type is ever sent to a server.
